...
public protocol MediaReceiver {
  func sendVideo(_: MediaChunk)
  func end()
}

public class VideoFile: MediaReceiver {
  ...
  public func sendVideo(_ chunk: MediaChunk) {
...
public class AVAssetReceiver: MediaReceiver {
  ...
  public init?(to filePath: String) {
