...
public struct MediaChunk {
  public private(set) var outputPresentation = Time.NULL  // opts
  public private(set) var sampleTiming = [TimingData]()  // stia
  public private(set) var sampleData = Data(count: 0)  // sdat, aka nalu
  public private(set) var sampleCount = UInt32(0)  // nsmp
  public private(set) var sampleSize = [Int]()  // ssiz
  public private(set) var formatDescription: FormatDescription? = nil  // fdsc
  public private(set) var attachments = Array()  // satt
  public private(set) var sampleReady = Array()  // sary
  ...
  public init(_ fdesc: FormatDescription, mediaType: ChunkType = .video) {
    self.formatDescription = fdesc
    self.mediaType = mediaType
  }

  public init?(_ data: Data, mediaType: ChunkType = .video) {
    self.mediaType = mediaType
    var idx = 0
  ...
  public func sampleBuffer(_ bufferCount: Int, fd: CMFormatDescription? = nil)
    -> CMSampleBuffer
  {
...
public struct TimingData {
  public private(set) var duration: Time
  public private(set) var presentation: Time
  public private(set) var decode: Time

  public static let size = Time.size * 3
